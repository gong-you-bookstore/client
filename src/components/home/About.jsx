        ...
        <div className="flex-box">
          <div className="content-info-left">
            <Fade direction="up" cascade triggerOnce>
              <p className="info-text fc-dark">
                잠들어 있는 <br />
                책을 <span className="fc-main fw-bold">검색</span> 하고
                <br />
          ...
          <div className="content-info-right">
            ...
            <Fade direction="up" cascade triggerOnce>
              <p className="info-text fc-dark">
                주변 친구들과
                <br />
                책을 <span className="fc-main fw-bold">공유</span> 하고
                <br />
                토큰으로
                <br /> <span className="fc-main fw-bold">교환</span> 해보세요
              </p>
            </Fade>
          </div>
        </div>
